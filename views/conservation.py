...
# -*- coding: utf-8 -*-
"""
Conservation Dialog - Create/Edit conservation for Inventarium.
...
class UI(tk.Toplevel):
    """Dialog for creating or editing a conservation."""

    def __init__(self, parent, index=None):
        super().__init__(name="conservation")
    ...
    def on_open(self, selected_item=None):
        """
        Open dialog for new or edit conservation.

        Args:
            selected_item: Dict with conservation data (for edit) or None (for new)
        """
    ...
    def set_values(self):
        """Set form values from selected conservation."""
    ...
    def check_description(self):
        ...
        sql = "SELECT conservation_id FROM conservations WHERE description = ?"
