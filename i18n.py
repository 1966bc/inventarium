...
TRANSLATIONS = {
    ...
    "Salva Backup Database": {"it": "Salva Backup Database", "en": "Save Database Backup", "es": "Guardar Copia de Seguridad"},
    "Backup completato!": {"it": "Backup completato!", "en": "Backup completed!", "es": "¡Copia de seguridad completada!"},
    "Errore durante il backup:": {"it": "Errore durante il backup:", "en": "Error during backup:", "es": "Error durante la copia de seguridad:"},
    ...
    "Configurazione Database": {"it": "Configurazione Database", "en": "Database Configuration", "es": "Configuración de Base de Datos"},
    "Configura Percorso Database": {"it": "Configura Percorso Database", "en": "Configure Database Path", "es": "Configurar Ruta de Base de Datos"},
    "Configurazione del percorso database.": {"it": "Configurazione del percorso database.", "en": "Database path configuration.", "es": "Configuración de la ruta de base de datos."},
    "Selezionare il file database SQLite (.db)": {"it": "Selezionare il file database SQLite (.db)", "en": "Select the SQLite database file (.db)", "es": "Seleccione el archivo de base de datos SQLite (.db)"},
    "o inserire manualmente il percorso.": {"it": "o inserire manualmente il percorso.", "en": "or enter the path manually.", "es": "o ingrese la ruta manualmente."},
    "Percorso:": {"it": "Percorso:", "en": "Path:", "es": "Ruta:"},
    "Sfoglia...": {"it": "Sfoglia...", "en": "Browse...", "es": "Examinar..."},
    "Test Connessione": {"it": "Test Connessione", "en": "Test Connection", "es": "Probar Conexión"},
    "OK": {"it": "OK", "en": "OK", "es": "Aceptar"},
    "Inserire un percorso": {"it": "Inserire un percorso", "en": "Enter a path", "es": "Ingrese una ruta"},
    "File non trovato": {"it": "File non trovato", "en": "File not found", "es": "Archivo no encontrado"},
    "Database non valido": {"it": "Database non valido", "en": "Invalid database", "es": "Base de datos no válida"},
    "prodotti trovati": {"it": "prodotti trovati", "en": "products found", "es": "productos encontrados"},
    "Errore": {"it": "Errore", "en": "Error", "es": "Error"},
    "Seleziona Database": {"it": "Seleziona Database", "en": "Select Database", "es": "Seleccionar Base de Datos"},
    "Tutti i file": {"it": "Tutti i file", "en": "All files", "es": "Todos los archivos"},
    "Configurazione": {"it": "Configurazione", "en": "Configuration", "es": "Configuración"},
    "Inserire un percorso valido.": {"it": "Inserire un percorso valido.", "en": "Enter a valid path.", "es": "Ingrese una ruta válida."},
    "Il file non esiste:": {"it": "Il file non esiste:", "en": "File does not exist:", "es": "El archivo no existe:"},
    "Continuare comunque?": {"it": "Continuare comunque?", "en": "Continue anyway?", "es": "¿Continuar de todos modos?"},
    "Percorso database aggiornato.": {"it": "Percorso database aggiornato.", "en": "Database path updated.", "es": "Ruta de base de datos actualizada."},
    "Riavviare l'applicazione per utilizzare il nuovo database.": {"it": "Riavviare l'applicazione per utilizzare il nuovo database.", "en": "Restart the application to use the new database.", "es": "Reinicie la aplicación para usar la nueva base de datos."},
    "Riavviare ora?": {"it": "Riavviare ora?", "en": "Restart now?", "es": "¿Reiniciar ahora?"},
    "Database non trovato.": {"it": "Database non trovato.", "en": "Database not found.", "es": "Base de datos no encontrada."},
    "Cosa vuoi fare?": {"it": "Cosa vuoi fare?", "en": "What do you want to do?", "es": "¿Qué quieres hacer?"},
    "Cerca database esistente...": {"it": "Cerca database esistente...", "en": "Find existing database...", "es": "Buscar base de datos existente..."},
    "Crea nuovo database": {"it": "Crea nuovo database", "en": "Create new database", "es": "Crear nueva base de datos"},
    "Crea Nuovo Database": {"it": "Crea Nuovo Database", "en": "Create New Database", "es": "Crear Nueva Base de Datos"},
    "Database Creato": {"it": "Database Creato", "en": "Database Created", "es": "Base de Datos Creada"},
    "Database creato con successo!": {"it": "Database creato con successo!", "en": "Database created successfully!", "es": "¡Base de datos creada con éxito!"},
    "Impossibile creare il database.": {"it": "Impossibile creare il database.", "en": "Unable to create database.", "es": "No se puede crear la base de datos."},
    "Il file selezionato non è un database Inventarium valido.": {"it": "Il file selezionato non è un database Inventarium valido.", "en": "The selected file is not a valid Inventarium database.", "es": "El archivo seleccionado no es una base de datos Inventarium válida."},
    "File init.sql non trovato!": {"it": "File init.sql non trovato!", "en": "File init.sql not found!", "es": "¡Archivo init.sql no encontrado!"},
    "Errore durante la creazione del database:": {"it": "Errore durante la creazione del database:", "en": "Error creating database:", "es": "Error al crear la base de datos:"},
    ...
    "Confezione:": {"it": "Confezione:", "en": "Package:", "es": "Envase:"},
    "Nuovo Articolo": {"it": "Nuovo Articolo", "en": "New Item", "es": "Nuevo Artículo"},
    "Ord": {"it": "Ord", "en": "Ord", "es": "Ped"},
    "Eva": {"it": "Eva", "en": "Del", "es": "Ent"},
    "Selezionare una categoria!": {"it": "Selezionare una categoria!", "en": "Select a category!", "es": "¡Seleccione una categoría!"},
    "Selezionare una confezione!": {"it": "Selezionare una confezione!", "en": "Select a package!", "es": "¡Seleccione un envase!"},
    "La quantità deve essere almeno 1!": {"it": "La quantità deve essere almeno 1!", "en": "Quantity must be at least 1!", "es": "¡La cantidad debe ser al menos 1!"},
    "Articolo già presente.": {"it": "Articolo già presente.", "en": "Item already exists.", "es": "Artículo ya existe."},
    "La quantità è stata sommata.": {"it": "La quantità è stata sommata.", "en": "Quantity has been added.", "es": "La cantidad ha sido sumada."},
    "Bozze": {"it": "Bozze", "en": "Drafts", "es": "Borradores"},
    "Inviate": {"it": "Inviate", "en": "Sent", "es": "Enviadas"},
    "Invia Richiesta": {"it": "Invia Richiesta", "en": "Send Request", "es": "Enviar Solicitud"},
    "Solo le bozze possono essere modificate!": {"it": "Solo le bozze possono essere modificate!", "en": "Only drafts can be edited!", "es": "¡Solo los borradores pueden ser editados!"},
    "Solo le bozze possono essere inviate!": {"it": "Solo le bozze possono essere inviate!", "en": "Only drafts can be sent!", "es": "¡Solo los borradores pueden ser enviados!"},
    "Impossibile inviare una richiesta senza articoli!": {"it": "Impossibile inviare una richiesta senza articoli!", "en": "Cannot send a request without items!", "es": "¡No se puede enviar una solicitud sin artículos!"},
    "Inviare la richiesta selezionata?": {"it": "Inviare la richiesta selezionata?", "en": "Send the selected request?", "es": "¿Enviar la solicitud seleccionada?"},
    "Articoli modificabili solo nelle bozze!": {"it": "Articoli modificabili solo nelle bozze!", "en": "Items can only be edited in drafts!", "es": "¡Los artículos solo pueden editarse en borradores!"},
    "Articoli eliminabili solo nelle bozze!": {"it": "Articoli eliminabili solo nelle bozze!", "en": "Items can only be deleted in drafts!", "es": "¡Los artículos solo pueden eliminarse en borradores!"},
    "Articoli annullabili solo nelle richieste inviate!": {"it": "Articoli annullabili solo nelle richieste inviate!", "en": "Items can only be cancelled in sent requests!", "es": "¡Los artículos solo pueden anularse en solicitudes enviadas!"},
    "Le bozze non possono essere chiuse.": {"it": "Le bozze non possono essere chiuse.", "en": "Drafts cannot be closed.", "es": "Los borradores no pueden cerrarse."},
    "Inviarle prima o eliminarle.": {"it": "Inviarle prima o eliminarle.", "en": "Send them first or delete them.", "es": "Envíelos primero o elimínelos."},
    "La richiesta è già chiusa!": {"it": "La richiesta è già chiusa!", "en": "The request is already closed!", "es": "¡La solicitud ya está cerrada!"},
    "Chiudere la richiesta selezionata?": {"it": "Chiudere la richiesta selezionata?", "en": "Close the selected request?", "es": "¿Cerrar la solicitud seleccionada?"},
    "Annullato": {"it": "Annullato", "en": "Cancelled", "es": "Anulado"},
    "Nota": {"it": "Nota", "en": "Note", "es": "Nota"},
    "Non ci sono più articoli attivi.": {"it": "Non ci sono più articoli attivi.", "en": "There are no more active items.", "es": "No hay más artículos activos."},
    "Chiudere la richiesta?": {"it": "Chiudere la richiesta?", "en": "Close the request?", "es": "¿Cerrar la solicitud?"},
    "Motivo annullamento:": {"it": "Motivo annullamento:", "en": "Cancellation reason:", "es": "Motivo de anulación:"},
    "Annulla Articolo": {"it": "Annulla Articolo", "en": "Cancel Item", "es": "Anular Artículo"},
    "Inserire il motivo dell'annullamento!": {"it": "Inserire il motivo dell'annullamento!", "en": "Enter the cancellation reason!", "es": "¡Ingrese el motivo de la anulación!"},
    "Confermare l'annullamento dell'articolo?": {"it": "Confermare l'annullamento dell'articolo?", "en": "Confirm item cancellation?", "es": "¿Confirmar anulación del artículo?"},
    "L'articolo è già stato annullato.": {"it": "L'articolo è già stato annullato.", "en": "The item has already been cancelled.", "es": "El artículo ya ha sido anulado."},
    "Impossibile eliminare un articolo annullato.": {"it": "Impossibile eliminare un articolo annullato.", "en": "Cannot delete a cancelled item.", "es": "No se puede eliminar un artículo anulado."},
    "Articolo annullato.": {"it": "Articolo annullato.", "en": "Item cancelled.", "es": "Artículo anulado."},
    "Motivo": {"it": "Motivo", "en": "Reason", "es": "Motivo"},
    "Dettaglio:": {"it": "Dettaglio:", "en": "Detail:", "es": "Detalle:"},
    "Nota:": {"it": "Nota:", "en": "Note:", "es": "Nota:"},
    "Eliminare l'articolo selezionato?": {"it": "Eliminare l'articolo selezionato?", "en": "Delete the selected item?", "es": "¿Eliminar el artículo seleccionado?"},
    "Eliminare la richiesta '{}' e tutti i suoi articoli?": {"it": "Eliminare la richiesta '{}' e tutti i suoi articoli?", "en": "Delete request '{}' and all its items?", "es": "¿Eliminar la solicitud '{}' y todos sus artículos?"},
    "La richiesta non contiene articoli.": {"it": "La richiesta non contiene articoli.", "en": "The request contains no items.", "es": "La solicitud no contiene artículos."},
    "Errore nella generazione del report:": {"it": "Errore nella generazione del report:", "en": "Error generating report:", "es": "Error al generar el informe:"},
    "Selezionare prima una richiesta!": {"it": "Selezionare prima una richiesta!", "en": "Select a request first!", "es": "¡Seleccione primero una solicitud!"},
    "Selezionare un articolo!": {"it": "Selezionare un articolo!", "en": "Select an item!", "es": "¡Seleccione un artículo!"},
    "Stampa disabilitata su questa postazione.": {"it": "Stampa disabilitata su questa postazione.", "en": "Printing disabled on this workstation.", "es": "Impresión deshabilitada en esta estación."},
    "Impostazioni locali": {"it": "Impostazioni locali", "en": "Local settings", "es": "Configuración local"},
    "Stampa etichette:": {"it": "Stampa etichette:", "en": "Label printing:", "es": "Impresión de etiquetas:"},
    "Abilitata su questa postazione": {"it": "Abilitata su questa postazione", "en": "Enabled on this workstation", "es": "Habilitada en esta estación"},
    ...
    "Articoli da Evadere": {"it": "Articoli da Evadere", "en": "Items to Fulfill", "es": "Artículos a Despachar"},
    "Dettaglio Articolo": {"it": "Dettaglio Articolo", "en": "Item Details", "es": "Detalle del Artículo"},
    "Già Evaso:": {"it": "Già Evaso:", "en": "Already Fulfilled:", "es": "Ya Despachado:"},
    "DDT:": {"it": "DDT:", "en": "Delivery Note:", "es": "Albarán:"},
    "Data Consegna:": {"it": "Data Consegna:", "en": "Delivery Date:", "es": "Fecha de Entrega:"},
    "Seleziona esistente:": {"it": "Seleziona esistente:", "en": "Select existing:", "es": "Seleccionar existente:"},
    "Crea nuovo:": {"it": "Crea nuovo:", "en": "Create new:", "es": "Crear nuevo:"},
    "Scad": {"it": "Scad", "en": "Exp", "es": "Cad"},
    "Selezionare un articolo da evadere!": {"it": "Selezionare un articolo da evadere!", "en": "Select an item to fulfill!", "es": "¡Seleccione un artículo a despachar!"},
    "Inserire il numero DDT!": {"it": "Inserire il numero DDT!", "en": "Enter the delivery note number!", "es": "¡Ingrese el número del albarán!"},
    "Data consegna non valida!": {"it": "Data consegna non valida!", "en": "Invalid delivery date!", "es": "¡Fecha de entrega no válida!"},
    "La quantità deve essere tra 1 e": {"it": "La quantità deve essere tra 1 e", "en": "Quantity must be between 1 and", "es": "La cantidad debe estar entre 1 y"},
    "La quantità deve essere un multiplo di": {"it": "La quantità deve essere un multiplo di", "en": "Quantity must be a multiple of", "es": "La cantidad debe ser múltiplo de"},
    "Selezionare un lotto esistente!": {"it": "Selezionare un lotto esistente!", "en": "Select an existing batch!", "es": "¡Seleccione un lote existente!"},
    "Inserire il numero di lotto!": {"it": "Inserire il numero di lotto!", "en": "Enter the batch number!", "es": "¡Ingrese el número de lote!"},
    "Data scadenza non valida!": {"it": "Data scadenza non valida!", "en": "Invalid expiration date!", "es": "¡Fecha de caducidad no válida!"},
    "La data di scadenza deve essere futura!": {"it": "La data di scadenza deve essere futura!", "en": "Expiration date must be in the future!", "es": "¡La fecha de caducidad debe ser futura!"},
    "Il lotto": {"it": "Il lotto", "en": "Batch", "es": "El lote"},
    "con scadenza": {"it": "con scadenza", "en": "with expiration", "es": "con caducidad"},
    "Selezionarlo dalla lista dei lotti esistenti.": {"it": "Selezionarlo dalla lista dei lotti esistenti.", "en": "Select it from the existing batches list.", "es": "Selecciónelo de la lista de lotes existentes."},
    "Registrare la consegna di": {"it": "Registrare la consegna di", "en": "Record delivery of", "es": "Registrar entrega de"},
    "unità?": {"it": "unità?", "en": "units?", "es": "unidades?"},
    "Verranno create": {"it": "Verranno create", "en": "Will create", "es": "Se crearán"},
    "etichette.": {"it": "etichette.", "en": "labels.", "es": "etiquetas."},
    "etichetta": {"it": "etichetta", "en": "label", "es": "etiqueta"},
    "Errore nella creazione del lotto!": {"it": "Errore nella creazione del lotto!", "en": "Error creating batch!", "es": "¡Error al crear el lote!"},
    "Errore nella registrazione della consegna!": {"it": "Errore nella registrazione della consegna!", "en": "Error recording delivery!", "es": "¡Error al registrar la entrega!"},
    "Consegna registrata con successo!": {"it": "Consegna registrata con successo!", "en": "Delivery recorded successfully!", "es": "¡Entrega registrada con éxito!"},
    "Create": {"it": "Create", "en": "Created", "es": "Creadas"},
    "Errore durante il salvataggio:": {"it": "Errore durante il salvataggio:", "en": "Error during save:", "es": "Error al guardar:"},
    "Tutti gli articoli sono stati evasi.": {"it": "Tutti gli articoli sono stati evasi.", "en": "All items have been fulfilled.", "es": "Todos los artículos han sido despachados."},
    "La richiesta è stata chiusa.": {"it": "La richiesta è stata chiusa.", "en": "The request has been closed.", "es": "La solicitud ha sido cerrada."},
    ...
    "Scarico Etichetta": {"it": "Scarico Etichetta", "en": "Unload Label", "es": "Descargar Etiqueta"},
    "Scansiona il barcode o inserisci il codice etichetta:": {"it": "Scansiona il barcode o inserisci il codice etichetta:", "en": "Scan barcode or enter label code:", "es": "Escanear código de barras o ingresar código de etiqueta:"},
    "Codice a barre:": {"it": "Codice a barre:", "en": "Barcode:", "es": "Código de barras:"},
    "Codice non valido!": {"it": "Codice non valido!", "en": "Invalid code!", "es": "¡Código inválido!"},
    "Etichetta": {"it": "Etichetta", "en": "Label", "es": "Etiqueta"},
    "non trovata!": {"it": "non trovata!", "en": "not found!", "es": "¡no encontrada!"},
    "già scaricata!": {"it": "già scaricata!", "en": "already unloaded!", "es": "¡ya descargada!"},
    "annullata!": {"it": "annullata!", "en": "cancelled!", "es": "¡cancelada!"},
    "Scaricata:": {"it": "Scaricata:", "en": "Unloaded:", "es": "Descargada:"},
    "Errore nello scarico!": {"it": "Errore nello scarico!", "en": "Error unloading!", "es": "¡Error al descargar!"},
