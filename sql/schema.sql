--
-- File generated with SQLiteStudio v3.4.3 on mer gen 7 12:57:38 2026
--
...
CREATE TABLE IF NOT EXISTS "packages" (
    ...
    location_id INTEGER,
    status INTEGER NOT NULL DEFAULT 1, order_by_piece INTEGER NOT NULL DEFAULT 1, pieces_per_label INTEGER NOT NULL DEFAULT 1, reorder INTEGER NOT NULL DEFAULT 0, funding_id INTEGER REFERENCES funding_sources(funding_id), labels_per_unit INTEGER DEFAULT 1, label_text VARCHAR(40), label_font_size INTEGER DEFAULT 36, shelf VARCHAR(20),
